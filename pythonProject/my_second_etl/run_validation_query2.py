...
python ./my_second_etl/run_validation_query2.py
...
bi_path = os.path.expanduser(home + '/my_second_etl/')
bi_auth = os.path.expanduser(home + '/my_second_etl/auth/')
data_path = os.path.expanduser(home + '/my_second_etl/temp/data/')
logs_path = os.path.expanduser(home + '/my_second_etl/temp/logs/')
...
# Set the log table
log_table="strange-bay-433318-g0.logs2.bi_jobs"
...
# File path
fileName = os.path.join(bi_path, 'etl_validations_google_geo_us_census_places.sql')
